...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public BaseDatos(@Nullable Context context) {
        super(context, ConstantesBaseDatos.DATABASE_NAME, null,ConstantesBaseDatos.DATABASE_VER);
...
public ArrayList<pet> obtenerTodosLosContactos() {
    ArrayList<pet> contactos = new ArrayList<>();
